...
#boxs
#-----------------------------------
about_box = Box(app , align="up" , border=True , width="fill" , height=200) #بردر برای اینکه باکس رو فعلا تشخیض بدیم
...
calculation_box = Box(app , width="fill" , height=200 , border=True
