...
#boxs
#-----------------------------------
about_box = Box(chegali_app , border=True , width="fill" , height=200) #بردر برای اینکه باکس رو فعلا تشخیض بدیم
...
calculation_box = Box(chegali_app , width="fill" , height=260 , border=True

    )
footer_box = Box(chegali_app ,width="fill" , height=80 , border=True) 
